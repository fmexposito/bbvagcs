...
function imagen_para(tag){
		 switch (tag) {
				...
				case "Insertar emoticon": return "smile.gif";break
				case "Codigo": return "code.gif"; break
				case "Cita": return "quote.gif"; break
...
function inssmile (tag,contenedor){
		 var resultado="";
		 resultado="["+tag+"]";
		 insertar_en (resultado,contenedor);
		 }
...
function editor_para(contenedor){
		...
		// html_btn+=boton("Insertar emoticon",contenedor);
		 html_btn+=boton("|",contenedor);
		// html_btn+=boton("Codigo",contenedor);
